...
<body>
<h1 align="center" style="font:50px arial; letter-spacing:15px; text-transform:uppercase; background-color:aqua; margin:8px 0px;">Database Records</h1>
...
<?php
           ...
           <td><a href="./uninstal.php?myid=<?php echo $fet['ssr']; ?>">Delete</a></td>
